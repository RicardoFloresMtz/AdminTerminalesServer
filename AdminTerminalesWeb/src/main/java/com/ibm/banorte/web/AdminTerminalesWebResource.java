...
@Path("/resource")
public class AdminTerminalesWebResource {
	/*
	...
	static Logger logger = Logger.getLogger(AdminTerminalesWebResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/AdminTerminalesWeb/resource/protected"
	 */
